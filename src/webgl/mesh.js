...
export default class Mesh {
    constructor(stage, elementOption) {
        ...
        this.path = "https://hisamikurita.github.io/threejs-scroll-noise-image/dist/images/noise03.jpg";
        ...
        this.uniforms = {
            ...
            u_texture: { type: "t", value: new THREE.TextureLoader().load(elementOption.img) },
